...
import gridImg from '../assets/images/gradient.png';
// import arrowObj from '../models/dot_arrow.glb';
...
spotMesh.position.set(9, 0.005, 9);
...
// gltfLoader.load(
// 	arrowObj, function(gltf){
// 		const arrows = gltf.scene;
// 		arrows.position.set(0.2,0,3);
// 		arrows.scale.set(15, 15, 15);
// 		arrows.rotation.x = -4.7;
// 		scene.add(arrows);
// 	}
// );
...
// 	arrowObj, function(gltf){
// 		const arrows = gltf.scene;
// 		arrows.position.set(1.2,0,4.5);
// 		arrows.scale.set(0.2, 0.2, 0.2);
// 		scene.add(arrows);
// 	}
// );
